...
"""
В качестве структуры данных для стека выбран двунаправленный связный список.
Так как операции добавления в стек, удаления и получения значения из верхушки стека выполняется за время О(1).
В динамическом массиве при аллокации, время выполнения операций добавления/удаления займет О(n).
"""
